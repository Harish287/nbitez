...
const PopularProducts = ({ grid = 3, type = 'grid' }: { grid?: number | boolean, type?: string }) => {
  ...
  const { isLoading, data: productsList, isSuccess, isError } = useGetAllProductsQuery('api/product');
    ...
    <section>
      <div className="container-fluid">
        ...
        <div className='px-3 px-lg-5 py-4 mb-5'>
          ...
          <div className="day-deals-rated row justify-content-between text-black mt-5" style={{ minHeight: "400px" }}>
...
export {
  Section, BlogAndNews, PopularProducts, SortProducts,
  //  AllCategory,
  Category
};