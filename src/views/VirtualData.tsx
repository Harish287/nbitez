...
export type CategoryType = {
  ...
  onclick: (categoryId: string | number) => void; // Function type for the click handler
  categoryId: number | null; // categoryId is a number or null (useful for selecting a category)
};
...
export const blogInfo = [
  { blog_id: 1, date: '21 Dec 2023', img: '/img/blog/1.jpg', title: 'How to manage your e-commerce shopify account ?', content: "Lorem ipsum dolor sit amet consectetur adipisicing elit ...", authorName: 'Elfried KIDJE', authorImg: '/img/author.jpg' },
  { blog_id: 2, date: '21 Dec 2023', img: '/img/blog/2.jpg', title: 'How to manage your e-commerce shopify account ?', content: "Lorem ipsum dolor sit amet consectetur adipisicing elit ...", authorName: 'Elfried KIDJE', authorImg: '/img/author.jpg' },
  { blog_id: 3, date: '21 Dec 2023', img: '/img/blog/3.jpg', title: 'How to manage your e-commerce shopify account ?', content: "Lorem ipsum dolor sit amet consectetur adipisicing elit ...", authorName: 'Elfried KIDJE', authorImg: '/img/author.jpg' }
...
export const dailyTest = {
  id: 1, img: '/img/product/1.png', reviews: 4, name: 'Product Name 1', price: 90, old_price: 100, desc: "Lorem ipsum dolor sit amet consectetur adipisicing elit. Sed earum nemo, officia maiores corporis eveniet ratione magnam facere voluptates consequuntur cumque.", total_quantity: 3
}
